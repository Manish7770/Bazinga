...
public class ChangeNightMenu extends AppCompatActivity {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference heading,nightstocks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nightstock);
        ...
        nightstocks=database.getReference("Night's Menu");
    ...
    public void onBackPressed() {
        if (Common.isConnectedToInternet(this)) {
            Intent intent = new Intent(this, NightMenu.class);
    ...
    public boolean onSupportNavigateUp(){
        if (Common.isConnectedToInternet(this)) {
            Intent intent = new Intent(ChangeNightMenu.this, NightMenu.class);
            startActivity(intent);
        }
        else
        {
    ...
    private void loadFood(String menuItemsId) {
        ...
        Query query = nightstocks.orderByChild("MenuId").equalTo(MenuItemsId);
                ...
                if(model.getStock().equals("1")) {
                    ...
                    holder.deletestock.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            nightstocks.child(adapter.getRef(position).getKey()).child("Stock").setValue("0");
                        }
                    });
                }
                else {
                    ...
                    holder.addstock.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            holder.addstock.setVisibility(View.INVISIBLE);
                            holder.deletestock.setVisibility(View.VISIBLE);
                            nightstocks.child(adapter.getRef(position).getKey()).child("Stock").setValue("1");
                        }
                    });
                }
