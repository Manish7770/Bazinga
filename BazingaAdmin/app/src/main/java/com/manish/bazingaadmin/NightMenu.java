...
public class NightMenu extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nightmenu);
        Toolbar toolbar = findViewById(R.id.NightMenuToolbar);
        toolbar.setTitle("Night's Menu");
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder holder, int position, @NonNull MenuItems model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent intent=new Intent(NightMenu.this,ChangeNightMenu.class);
